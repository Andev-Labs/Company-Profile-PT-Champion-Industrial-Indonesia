      ...
      <div className="max-w-shell px-shell py-section mx-auto">
        ...
        <ul className="reveal-on-scroll bg-line border-line grid grid-cols-1 gap-px border sm:grid-cols-2 lg:grid-cols-3">
          {industries.map((no) => (
            <li
              key={no}
              className="hover:border-t-brand flex flex-col border-t-[3px] border-t-transparent bg-white px-6 py-8 transition-colors duration-200 sm:min-h-53 lg:px-8.5 lg:py-9.5"
            >
