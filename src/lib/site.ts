...
export const site = {
   ...
   * the coordinates below. Nothing renders it since ANDEV-131 stripped the
   * contact section back to the form — the footer links out to Google Maps
   * instead — but it is kept here as the company-supplied record.
   */
  mapsEmbedUrl:
