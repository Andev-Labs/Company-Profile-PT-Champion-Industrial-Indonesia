    ...
    <section className="bg-brand text-white">
      <div className="max-w-shell px-shell mx-auto grid grid-cols-1 items-center gap-9 py-16 lg:grid-cols-[minmax(0,1fr)_auto] lg:gap-16 lg:py-21">
        ...
        <a
          ...
          className="text-brand text-cta hover:bg-ink reveal-on-scroll group inline-flex items-center justify-center gap-3 bg-white px-8.5 py-5 font-bold whitespace-nowrap hover:text-white"
        >
